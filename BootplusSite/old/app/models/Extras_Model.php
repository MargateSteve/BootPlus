...
class Extras_Model extends Functions
{
	public function overview ()
	{
		$typography = new Typography_Model;
		$backgrounds = new Background_Model;

		$output = $typography->other_colors($palette=true);
		$output .= $backgrounds->other_colors($palette=true);
