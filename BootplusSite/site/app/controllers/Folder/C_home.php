...
class C_Home extends Controller
{
	...
	public function index() {
        $m = $this->model('M_Root');
        $view_data = [
            'page_title' => 'Home page in folder',
            'page_subtitle' => 'Navigated to a folder with no controller',
            'function' => 'index',
            'content' => $m->home_page()
        ];
    ...
    public function Method() {
        ...
        $view_data = [
            ...
            'page_subtitle' => 'Navigated to a folder with no controller but a method',
