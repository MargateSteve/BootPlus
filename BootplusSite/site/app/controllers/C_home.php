...
class C_Home extends Controller
{
    ...
    public function Method() {
        ...
        $view_data = [
            ...
            'page_subtitle' => 'URL points to a method within the home controller',
    ...
    public function Extras() {
        $m = $this->model('M_Root');
        $view_data = [
            'page_title' => 'Extra params',
            'page_subtitle' => 'Examples of the page-specific extras',
            'function' => 'add_extras',
            'content' => 'Added meta tags, css files, js files, in-page js'
        ];
        debugging_method(__FILE__,__FUNCTION__,func_get_args());
